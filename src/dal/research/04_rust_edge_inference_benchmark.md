...
| :--- | :--- | :--- | :--- | :--- |
| **Latência Média** | **21.675 µs (0.0217 ms)** | < 5,0 ms | < 200,0 ms | **Aprovado (230.7x mais rápido)** |
| **Mediana (p50)** | **21.161 µs (0.0212 ms)** | < 5,0 ms | < 200,0 ms | **Aprovado** |
| **Percentil 95 (p95)** | **24.239 µs (0.0242 ms)** | < 5,0 ms | < 200,0 ms | **Aprovado** |
| **Percentil 99 (p99)** | **27.615 µs (0.0276 ms)** | < 5,0 ms | < 200,0 ms | **Aprovado** |
| **Mínimo Absoluto** | **20.740 µs** | - | - | - |
| **Máximo Absoluto** | **44.049 µs** | - | - | - |
